...
public:
  //enum
    struct Color {
        static QVector3D White(){return QVector3D(1.0f, 1.0f, 1.0f);}
        static QVector3D Red() {return QVector3D(1.0f, 0.0f, 0.0f);}
        static QVector3D Green(){return QVector3D(0.0f, 1.0f, 0.0f);}
        static QVector3D Blue() {return QVector3D(0.0f, 0.0f, 1.0f);}
        static QVector3D LightGrey() {return QVector3D(0.75f, 0.75f, 0.75f);}
        static QVector3D Grey() {return QVector3D(0.5f, 0.5f, 0.5f);}
        static QVector3D DarkGrey() {return QVector3D(0.25f, 0.25f, 0.25f);}
        static QVector3D Black() {return QVector3D(0.0f, 0.0f, 0.0f);}
    };
  // Constructors
